...
public class TicTacToe {
	...
	void checkWin() {
		if(b1==1&&b2==1&&b3==1) {
			JOptionPane.showConfirmDialog( f1,"Player X Wins","TIC TAC TOE",JOptionPane.OK_OPTION);
			xCount++;
			...
			JOptionPane.showConfirmDialog( f1,"Player O Wins","TIC TAC TOE",JOptionPane.OK_OPTION);
			oCount++;
			...
			JOptionPane.showConfirmDialog( f1,"Match Tie","TIC TAC TOE",JOptionPane.OK_OPTION);
	...
	private void initialize() {
		...
		panel_5.add(txtPlayerX, BorderLayout.WEST);
		...
		btnExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(JOptionPane.showConfirmDialog(f1,"DO You Want To Exit","TIC TAK TOE",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION) {
				System.exit(0);
				}
			}
		});
		...
		panel_16.add(btnExit, BorderLayout.CENTER);
	}
